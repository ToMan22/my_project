<div class="content-category-menu">
  <h5 class="text-bold mt-3">Content Categorise</h5>
  <ul class="nav flex-column category-nav">
    @foreach (\App\ContentCategory::latest()->get() as $contentCategory)
    <li class="nav-item">
      <a href="{{ route('content.show', $contentCategory) }}" role="button"
