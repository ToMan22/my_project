    ...
    <div class="col-12">
        ...
        <div class="pl-3 pr-3 pt-2">
            ...
            <div class="d-flex flex-column-reverse">
                <div class="w-100">
                    <textarea id="dropzone-uploader" name="input-text" class="form-control border dropzone w-100"
                        rows="3" spellcheck="false"
                        placeholder="{{__('Write a new post, drag and drop files to add attachments.')}}"
                        ...
                        <div class="flex-md-grow-1">
                            <div>
                                ...
                                <div class="form-group">
                                    <label>Select Post Categories</label>
                                    <div class="category-checkboxes">
                                        @foreach($contentCategorise as $contentCategory)
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" name="content_categories[]" 
                                                       id="category_{{$contentCategory->id}}" value="{{$contentCategory->id}}">
                                                <label class="custom-control-label" for="category_{{$contentCategory->id}}">
