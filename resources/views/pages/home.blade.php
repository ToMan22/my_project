        ...
        <div class="container h-100">
            <div class="row d-flex flex-row align-items-center h-100">
                <div class="col-12 col-md-6 mt-4 mt-md-0">
                    <h1 class="font-weight-bold text-gradient bg-gradient-primary">{{__('Find Best tgirl Content')}},</h1>
                    <h1 class="font-weight-bold text-gradient bg-gradient-primary">{{__('From Real Tgirl Content creators')}}.</h1>
                    <p class="font-weight-bold mt-3">🚀 {{__("Have fun with real tgirl images, videos, content on demand and optional live streaming.")}}</p>
                    <div class="mt-4">
                ...
                <div class="col-12 col-md-6 d-none d-md-block p-5">
                    <img src="{{asset('/img/tgirl-home(1).svg')}}" alt="{{__('Make more money')}}"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-4 my-4 white-section ">
        <div class="container">
            <div class="text-center">
                <h3 class="font-weight-bold">{{__("Create Your Account Now")}}</h3>
                <p>{{__("Start earing money from your content today")}} </p>
                <p>{{__("Or Start to having Fun with Your Favorite Tgirls")}} </p>
            </div>
        </div>
    </div>
@stop
